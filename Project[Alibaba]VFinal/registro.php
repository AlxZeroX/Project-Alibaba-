...
<!--FIN - CREACION DE Menu-->
    ...
    <br>
        ...
        <section id ="div-login2" class="form-control">
        <h1>Sign Up</h1>
        <form id="formulario">
        <input value="" id="txt-nombre" name="txt-nombre" type="text" placeholder="Nombre" ><br>
        <input value="" id="txt-apellido" name="txt-apellido" type="text" placeholder="Apellido" ><br>
        <input value="" id="txt-usuario" name="txt-usuario" type="text" placeholder="Usuario" ><br>
        <input value="" id="txt-email" name="txt-email" type="text" placeholder="email" ><br>
        <input value="" id="txt-password" name="txt-password" type="password" placeholder="Password" ><br>
        <input name="btn-enviar" type="button" value="sign in" id="btn-guardar" onclick = "location='home.php'">
